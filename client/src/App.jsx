...
export default function TaskManager() {
  ...
  const generatePDF = () => {
    ...
    autoTable(doc, {
      startY: 35,
      head: [['Ref', 'Prioridade', 'Solicitado Por', 'Título', 'Descrição Inicial', 'Verificação']],
      body: tableData,
      theme: 'grid',
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 text-slate-500 text-xs uppercase tracking-wider border-b border-slate-200">
                    ...
                    <th className="p-4 font-medium hidden md:table-cell">Prioridade</th>
                    <th className="p-4 font-medium hidden sm:table-cell">Solicitado Por</th>
                    <th className="p-4 font-medium w-1/3">Título</th>
                    <th className="p-4 font-medium hidden sm:table-cell">Estado</th>
